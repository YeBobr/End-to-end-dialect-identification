...
class E2E(ASRInterface, torch.nn.Module):
    ...
    # todo: batch decoding
    # please modify model.recognize() in "python3.7/site-packages/espnet/asr/pytorch_backend/asr.py" 
    # add a new parameter in the function.
    def recognize(self, x, recog_args, char_list=None, rnnlm=None, use_jit=False, name="xxxx"):
        ...
        logging.info(f"\nYeBobr minnan {name} {lpz[0][0]}\n"
                        f"YeBobr sichuan {name} {lpz[0][1]}\n"
                        f"YeBobr shanghai {name} {lpz[0][2]}" )
